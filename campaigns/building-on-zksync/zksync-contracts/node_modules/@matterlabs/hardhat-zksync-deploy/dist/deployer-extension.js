...
class DeployerExtension {
    constructor(_hre, _deploymentType) {
        this._hre = _hre;
        this._deploymentType = _deploymentType;
    }
    ...
    async deploy(contractNameOrArtifact, constructorArguments = [], overrides, additionalFactoryDeps) {
        ...
        return await (0, deployer_helper_1.deploy)(this._hre, contractNameOrArtifact, constructorArguments, this.wallet, this._deploymentType, overrides, additionalFactoryDeps);
    }
    ...
    async estimateDeployGas(artifact, constructorArguments) {
        ...
        return await (0, deployer_helper_1.estimateDeployGas)(this._hre, artifact, constructorArguments, this.wallet, this._deploymentType);
    }
    setWallet(wallet) {
        this.wallet = wallet;
    }
