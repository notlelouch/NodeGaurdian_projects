 ...
 */
class Deployer {
    constructor(_hre, zkWallet, deploymentType) {
        this._hre = _hre;
    ...
    async estimateDeployGas(artifact, constructorArguments) {
        return await (0, deployer_helper_1.estimateDeployGas)(this._hre, artifact, constructorArguments, this.zkWallet, this.deploymentType);
    }
    ...
    async deploy(contractNameOrArtifact, constructorArguments = [], overrides, additionalFactoryDeps) {
        return await (0, deployer_helper_1.deploy)(this._hre, contractNameOrArtifact, constructorArguments, this.zkWallet, this.deploymentType, overrides, additionalFactoryDeps);
    }
}
